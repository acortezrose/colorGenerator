...
export function CircleSampleForm({
	...
	const downloadSVGs = async () => {
		...
		swatchData.circleSamples.forEach((sample, idx) => {
			...
			const svgParts = {
				start: `<svg width="88" height="88" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_4740_1055)"><rect width="88" height="88" rx="24" fill="${hex}" />`,
